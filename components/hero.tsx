    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 pt-32 pb-20">
        ...
        >
          ...
          >
            Discover the Best{" "}
            <span className="text-[#FFD700]">Sunroof Solutions</span> for Your
            Car
          </h1>
          <p className="text-xl text-white/90 mb-8 leading-relaxed">
            Elevate your driving experience with premium sunroof solutions
            designed for style, comfort, and functionality. Join thousands of
