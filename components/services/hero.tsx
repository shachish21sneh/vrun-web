      ...
      <div className="relative container mx-auto px-4 pt-32 pb-20">
        ...
        >
          ...
          >
            ...
            <span className="text-[#FFD700]">Premium Sunroof Solutions</span>
          </h1>
          <p className="text-xl text-white/90 mb-8 leading-relaxed">
            Experience the freedom of open-sky driving with our expert sunroof
            solutions. From custom installations to repairs, we deliver quality
